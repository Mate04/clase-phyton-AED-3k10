...
def main():
    ...
    borrador_sinpreg()
    while pozo > 100000 or pozo < 4:
        print(ROJO+f'El dinero que {jugador} ingreso debe ser menor a 100000 y mayor a 4, porfavor ingrese una cantidad valida\n')
    ...
    if vueltasDadosJuego > 0:
        ...
        print(ROJO+"No has jugado ninguna partida"+BLANCO)
        borrador_pantalla()
main()